  ...
  <div class="app-content-header">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <!--begin::Col-->
        <div class="col-sm-6">
          <h3 class="mb-0">Dashboard Edit Pegawai</h3>
        </div>
        <!--end::Col-->
        <!--begin::Col-->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-end">
            ...
            <li class="breadcrumb-item active" aria-current="page">Dashboard Edit Pegawai</li>
          </ol>
        </div>
        <!--end::Col-->
      </div>
              ...
              <div class="col-lg-6">
                <form method="post" action="#">
                  ...
                  if (isset($_POST['simpanEdit'])) {
                    ...
                    if ($id) {
                      $sql = "UPDATE pegawai SET nim='$nim', nama='$nama', alamat='$alamat',
