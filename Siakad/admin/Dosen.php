                ...
                <div class="col-12">
                    ...
                    <div class="card mt-4">
                        ...
                        <form method="post" action="#">
                            <table>
                                <tr>
                                    <td><a href="./?p=Tambah dosen" class="btn btn-primary">Tambah Dosen</a></td>
                        ...
                        <table class="table table-striped table-hover">
                          ...
                          echo"<tr><td>$nomor</td><td>$d[nidn]</td><td>$d[nama]</td><td>$d[gender]</td><td>$d[matakuliah]</td>

                         
                          <td><a href='./?p=Detail-dosen&id=$d[id]' class='btn btn-xs btn-info'>Detail</a>
                          <a href='./?p=Edit-Dosen&id=$d[id]' class='btn btn-xs btn-warning'>Edit</a>
                          <a href='./?p=hapus-dosen&id=$d[id]' class='btn btn-xs btn-danger'
