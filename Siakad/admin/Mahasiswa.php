                ...
                <div class="col-12">
                    ...
                    <div class="card mt-4">
                        ...
                        <form method="post" action="#">
                            <table>
                                <tr>
                                    <td><a href="./?p=Tambah mahasiswa" class="btn btn-primary">Tambah Mahasiswa</a></td>
                        ...
                        <table class="table table-striped table-hover">
                          ...
                          echo"<tr><td>$nomor</td><td>$d[nim]</td><td>$d[nama]</td><td>$d[gender]</td><td>$prodi</td>

                          <td><a href='./?p=Detail-mhs&id=$d[id]' class='btn btn-xs btn-info'>Detail</a>
                          <a href='./?p=Edit&id=$d[id]' class='btn btn-xs btn-warning'>Edit</a>
                          <a href='./?p=hapus-mhs&id=$d[id]' class='btn btn-xs btn-danger'
                          onclick=\"return confirm('Apakah data akan dihapus?')\">Hapus</a></td></tr>";
                          }
                          ?>
                          </tbody>
                          </table>
