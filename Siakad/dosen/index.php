...
<html lang="en">
  ...
  <head>
    ...
    <title>Siakad | Theme Customize</title>
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  src="../assets/img/percobaan.png"
                  class="user-image rounded-circle shadow"
                  alt="User Image"
                />
                <span class="d-none d-md-inline">Muhammad Farrel Endika Galan</span>
              </a>
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-header text-bg-primary">
                  ...
                  />
                  <p>
                    Muhammad Farrel Endika Galan
                    <small>S1 Teknik Informatika</small>
                  </p>
                </li>
                <!--end::User Image-->
                <!--begin::Menu Body-->
      ...
      <aside class="app-sidebar bg-dark shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="./?p=Dashboard" class="brand-link">
            <!--begin::Brand Image-->
            <img
              src="../assets/img/UIN SAIZU (UIN Prof. KH. Saifuddin Zuhri) Logo (PNG2160p) - Vector69Com.png"
              alt="AdminLTE Logo"
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="./?p=jadwal-dosen" class="nav-link">
                  <i class="nav-icon bi bi-circle-fill"></i>
                  <p>Jadwal Matakuliah</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./?p=konsultasi" class="nav-link">
                  <i class="nav-icon bi bi-circle-fill"></i>
                  <p>Konsultasi</p>
                </a>
              </li>
                ...
                <!-- </li>
                  <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="./?p=Bayar UKT" class="nav-link">
                          <i class="nav-icon bi bi-record-circle-fill"></i>
                          <p>Bayar UKT</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="./?p=Pengisian KRS" class="nav-link">
                          <i class="nav-icon bi bi-record-circle-fill"></i>
                          <p>Pengisisan KRS</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="./?p=Nilai Mahasiswa" class="nav-link">
                          <i class="nav-icon bi bi-record-circle-fill"></i>
                          <p>Nilai Mahasiswa</p>
                        </a>
                  </li>
              ...
              <li class="nav-item">
                <a href="./?p=Ganti Password" class="nav-link">
                  <i class="nav-icon bi bi-circle-fill"></i>
                  <p>Ganti Password</p>
                </a>
              </li>
